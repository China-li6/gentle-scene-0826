...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/gentle-scene-0826#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-scene-0826
```

A live public deployment of this template is available at [https://gentle-scene-0826.templates.workers.dev](https://gentle-scene-0826.templates.workers.dev)
